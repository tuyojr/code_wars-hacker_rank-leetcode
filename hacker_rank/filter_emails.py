...
# Concept
# A filter takes a function returning True or False and applies 
# it to a sequence, returning a list of only those members of the 
# sequence where the function returned True. A Lambda function can 
