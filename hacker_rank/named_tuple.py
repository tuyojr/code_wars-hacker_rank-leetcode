...
# Basically, named_tuples are easy to create, lightweight object types.
# They turn tuples into convenient containers for simple tasks.
# With named_tuples, you don’t have to use integer indices for accessing members of a tuple.
