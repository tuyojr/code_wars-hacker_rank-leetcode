...
# It is immediately followed by the name of the attribute and 
# the attribute value.
...
# inside the HTML comment tags (<!-- Comments -->). Comments can 
# be multiline.
# All attributes have an attribute value.

# Input Format

# The first line contains an integer N, the number of lines in the HTML 
# code snippet.
...
# attributes type, data, width and height along with their respective values.
