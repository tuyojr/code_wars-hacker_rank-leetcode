...
# status update etc., other users in their network are able to 
# view this new post on their news feed. Users can also see 
# exactly when the post was published, i.e, how many hours, 
...
# In the first query, when we compare the time in UTC for both the 
# time stamps, we see a difference of 7 hours. which is 7 x 3600 
...
# of 1 day and 30 minutes. Or 24 x 3600 + 30 x 60 ===> 88200.