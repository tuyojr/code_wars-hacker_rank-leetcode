...
# Locked stub code in the editor reads a single string denoting P from stdin and uses 
# provided expression and your regular expressions to validate if P is a valid postal code.

# Output Format

# You are not responsible for printing anything to stdout. Locked stub code in the 
# editor does that.
...
# 1 1 0000 : (0, 0) and (0, 0) are two alternating digit pairs. Hence, it is an 
# invalid postal code.
