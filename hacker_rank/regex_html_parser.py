# HTML
# https://www.google.co.in/webhp?sourceid=chrome-instant&ion=1&espv=2&ie=UTF-8#q=What+is+HTML
# Hypertext Markup Language is a standard markup language used for 
...
# HTMLParser
# https://docs.python.org/3/library/html.parser.html#HTMLParser.HTMLParser
...
# https://docs.python.org/3/library/html.parser.html#html.parser.HTMLParser.handle_startendtag
# This method is called to handle the empty tag of an element. (For example: <br />)
# The tag argument is the name of the tag converted to lowercase.
# The attrs argument is a list of (name, value) pairs containing the attributes 
...
# (<!-- Comments -->).Comments can be multiline as well.
